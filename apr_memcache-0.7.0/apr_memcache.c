                                      ...
                                      apr_uint16_t flags)
{
    ...
    klen = _snprintf(conn->buffer, BUFFER_SIZE, " %u %u %u" MC_EOL, flags, timeout, data_size);
                    ...
                    apr_uint32_t timeout)
{
    ...
    klen = _snprintf(conn->buffer, BUFFER_SIZE, " %u" MC_EOL, timeout);
                                      ...
                                      apr_uint32_t *new_value)
{
    ...
    klen = _snprintf(conn->buffer, BUFFER_SIZE, " %u" MC_EOL, inc);
