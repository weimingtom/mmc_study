...
select memc_cas('cas:test', 'casvalue changed?', 999999);
select memc_get('cas:test');
select memc_get_cas('cas:test');
select memc_cas('cas:test', 'casvalue changed?', memc_get_cas('cas:test'));
select memc_get('cas:test');

select memc_set_by_key('A', 'cas:test', 'some value');
select memc_get_by_key('A', 'cas:test');
select memc_cas_by_key('A', 'cas:test', 'casvalue changed?', 999999);
select memc_get_by_key('A', 'cas:test');
select memc_get_cas_by_key('A', 'cas:test');
select memc_cas_by_key('A', 'cas:test', 'casvalue changed?', memc_get_cas_by_key('A', 'cas:test'));
select memc_get_by_key('A', 'cas:test');
